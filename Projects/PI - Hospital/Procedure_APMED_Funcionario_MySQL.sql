...
CALL apmed2.prc_inserir_funcionario_apmedNI(3, NULL , '137.112.700-00', 'Neide Vilariça Brásio', '1987-6-07', 'Africana', 'F', 
'Atendente', 'Carinha que mora logo ali', '(61) 9 9344-6464', 'neide@atendente.com', 1, 1, NULL, NULL);
...
# Script responsável por chamar a procedure
CALL apmed2.prc_update_funcionario_apmed(1,'754152-45', '828.656.600-95', 'Ary Barros Sousa', '1993-09-12', 'Americano', 'M', 
'Enfermeiro', 'Karolina do Sul', '(61) 9 9344-6464', 'zé@enfermeiro.com', NULL, NULL, 1, 2);
...
# Script responsável por chamar a procedure
CALL apmed2.prc_delete_funcionario_apmed(1);
