...
#			  (SELECT email_hosp FROM hospital WHERE email_hosp = email)
	...
	ELSE
        SELECT MAX(id_hosp) INTO id_hospt FROM hospital;
		INSERT INTO hospital (cnpj_hosp, raz_hosp, cep_hosp, end_hosp, tel_hosp, email_hosp)
		VALUES(id_hospt+1, cnpj, raz, cep, endereco, telefone, email);
	END IF;
END $$
DELIMITER ;
...
CALL apmed2.prc_inserir_hospital_apmed('02.560.878/0001-07', 'HOSPITAL ANCHIETA - LTDA', '72115-700', 
'Área Especial 8, 9, 10, St. C Norte Qnc - Taguatinga, Brasília', '(61) 3353-9000', 
'relacionamento@hospitalanchieta.com.br');
...
CALL apmed2.prc_update_hospital_apmed(1,'02.560.878/0001-07', 'HOSPITAL ANCHIETA - LTDA', '72115-700', 
'Área Especial 8, 9, 10, St. C Norte Qnc - Taguatinga, Brasília', '(61) 3353-9000', 
'relacionamento@hospitalanchieta.com.br');
...
CALL apmed2.prc_delete_hospital_apmed(1);
